...
{\fontsize{10pt}{12pt}\selectfont\color{alloy} Each event is a single dot, alpha-stacked into a carpet; M$\geq$7 events appear in heritage red, sized by magnitude. Plate boundaries (Bird, 2003) overlaid in onyx. Dual-handle year window, magnitude threshold, zoom presets, click-a-country to filter every panel. Hosted on GitHub Pages via Observable Framework.}
\end{center}
\vspace{-0.4em}
```

![](../final/task_12/state_overview.png){fig-align="center" width="86%"}

```{=latex}
\vspace{-0.6em}
\begin{center}
{\fontsize{10pt}{12pt}\selectfont\color{alloy}\textbf{Try it live:} \url{https://alexander-the-sufficient.github.io/data_vizualisation_with_ai/task_12/?v=2026-04-29}}\\[0.15em]
{\footnotesize\color{darkstone}\itshape Source: USGS ANSS Comprehensive Earthquake Catalog. \url{https://earthquake.usgs.gov/fdsnws/event/1/}}
\end{center}
```
