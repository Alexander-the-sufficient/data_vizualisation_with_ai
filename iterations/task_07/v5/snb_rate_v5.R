# Task 7 v5 — SNB policy rate, 2000-2026 (Tufte data-ink rigor).
...
#   line peak at ~1.75% but the value wasn't anchored. The new label
#   gives the chart cycle symmetry: "1.75% Jan 2000" at the start,
#   "1.75% Jun 2023" at the recovery peak, "0.00% Mar 2026" at the end.
#   Reader now sees the rate cycled back to the same magnitude it
#   started at before falling to zero.
#
...
out_pdf <- "iterations/task_07/v5/snb_rate_v5.pdf"
