# Task 8 v28 — Partners Group 2024 income statement Sankey, networkD3.
#
# v28 changes vs v27:
...
html_out <- "iterations/task_08/v28/pg_income_sankey_v28.html"
pdf_out  <- "iterations/task_08/v28/pg_income_sankey_v28.pdf"
