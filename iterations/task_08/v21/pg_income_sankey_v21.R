# Task 8 v21 — Partners Group 2024 income statement Sankey, networkD3.
#
# v21 changes vs v20:
#   * onRender now also zeroes out the body's CSS margin/padding so
#     Chrome's print-to-PDF doesn't insert a blank first page. v20's
#     output had the chart on page 2 because the htmlwidget injects
#     default body padding that pushed the content below the first
#     paper-height boundary.
#   * Cost-peel labels (Operating costs / Personnel / Other op exp /
#     Other costs / Tax / D&A / Finance expense) also switched to
#     compact form ("Personnel  658 m" instead of "Personnel CHF
#     658 m"). v20 only compacted cascade subtotals, leaving cost
#     labels long enough to overlap the cascade-subtotal labels at the
#     same y-band ("Personnel" landing on top of "Operating costs").
#
...
html_out <- "iterations/task_08/v21/pg_income_sankey_v21.html"
pdf_out  <- "iterations/task_08/v21/pg_income_sankey_v21.pdf"
