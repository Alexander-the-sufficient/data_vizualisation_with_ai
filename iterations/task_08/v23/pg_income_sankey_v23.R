# Task 8 v23 — Partners Group 2024 income statement Sankey, networkD3.
#
# v23 changes vs v22:
...
html_out <- "iterations/task_08/v23/pg_income_sankey_v23.html"
pdf_out  <- "iterations/task_08/v23/pg_income_sankey_v23.pdf"
