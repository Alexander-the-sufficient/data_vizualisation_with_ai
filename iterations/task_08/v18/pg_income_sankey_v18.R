# Task 8 v18 — Partners Group 2024 income statement Sankey, networkD3.
#
# v18 changes vs v17:
#   * sinksRight = FALSE so terminal cost peels (Personnel, D&A, Tax,
#     etc.) stop at their natural depth column instead of being jammed
#     against the right edge. v17 had sinksRight = TRUE which broke the
#     multi-column cascade: cost peels that should appear at column 3
#     or 4 were dragged to column 5/6 and produced wild arcs across
#     the chart.
#   * iterations = 32 (d3-sankey default) restored. Combined with the
#     manual node ordering (profit nodes listed first at each column,
#     costs after), the relax pass minimises crossings while still
#     honouring the desired vertical hierarchy.
...
html_out <- "iterations/task_08/v18/pg_income_sankey_v18.html"
pdf_out  <- "iterations/task_08/v18/pg_income_sankey_v18.pdf"
