# Task 8 v29 — Partners Group 2024 income statement Sankey, networkD3.
#
# v29 changes vs v28:
#   * Dividend's upward shift increased 75 -> 100 px so the terminal
#     Net profit -> Dividend link arcs upward by ~25 px (matching the
#     Revenue -> Op margin / Op margin -> Pre-tax / Pre-tax -> Net
#     profit steps). Previously Dividend shared Net profit's shift, so
#     that final segment ran flat.
#
# v28 changes vs v27:
...
html_out <- "iterations/task_08/v29/pg_income_sankey_v29.html"
pdf_out  <- "iterations/task_08/v29/pg_income_sankey_v29.pdf"
