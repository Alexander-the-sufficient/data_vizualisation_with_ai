# Task 9 v4 — Average sentence length in US inaugural addresses, 1789-2025.
#
# v4 vs v3:
...
out_pdf <- "iterations/task_09/v4/inaugural_sentence_length_v4.pdf"
ggsave(out_pdf, p, width = 26, height = 14, units = "cm", device = "pdf")
cat("\nSaved:", out_pdf, "\n")

write_csv(stats,
          "iterations/task_09/v4/inaugural_sentence_length_stats.csv")
