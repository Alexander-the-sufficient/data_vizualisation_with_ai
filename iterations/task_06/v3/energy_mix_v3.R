# Task 6 v3 — National electricity mixes, 2000-2025 (color is the aesthetic).
...
#   pattern we are now disallowing. v3 uses a sequential-style ramp
#   through the warm-neutral family, with the warm bronze accent reserved
#   for the chart's story (wind and solar — the fuel that's growing).
#   Coal stays Onyx because coal IS black (semantically loaded), which
#   the design system's discipline allows as a documented exception.
#
#   v3 mapping — bottom of stack (dirtiest) to top (cleanest):
#     Coal           Onyx         #000000  black, semantic
#     Gas & oil      Alloy        #5C5B59  warm charcoal
#     Nuclear        Dark Stone   #7E8182  neutral warm gray
#     Hydro & bio    Dark Quartz  #ACA39A  taupe
#     Wind & solar   Copper       #896C4C  warm bronze (accent)
#
...
cat_colors <- c(
  "Coal"         = pg_palette$onyx,        # #000000 black (semantic: coal IS black)
  "Gas & oil"    = pg_palette$alloy,       # #5C5B59 warm charcoal
  "Nuclear"      = pg_palette$dark_stone,  # #7E8182 neutral warm gray
  "Hydro & bio"  = pg_palette$dark_quartz, # #ACA39A taupe
...
out_pdf <- "iterations/task_06/v3/energy_mix_v3.pdf"
