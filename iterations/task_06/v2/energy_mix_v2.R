# Task 6 v2 — National electricity mixes, 2000-2025 (color is the aesthetic).
...
cat_colors <- c(
  "Coal"         = pg_palette$onyx,
  "Gas & oil"    = pg_palette$copper,
  "Nuclear"      = pg_palette$heritage_red,
  "Hydro & bio"  = pg_palette$dark_stone,
  "Wind & solar" = pg_palette$dark_quartz
)
...
out_pdf <- "iterations/task_06/v2/energy_mix_v2.pdf"
