# Task 2 v3 — honest remake of the White House steel chart, long context.
# v3 changes vs v2: no chart structure changes; design-system palette
#   migration only. `pg_palette$alloy` is now #5C5B59 (PG-brand warm
#   charcoal) and `pg_palette$copper` is now #896C4C (PG-brand warm
#   bronze). The two highlighted points (2024, 2025) render as muted
#   bronze instead of v2's saturated terracotta, in line with the new
#   "red and black are accents only; warm neutrals dominate" discipline.
#
...
out_pdf <- "iterations/task_02/v3/steel_production_v3.pdf"
