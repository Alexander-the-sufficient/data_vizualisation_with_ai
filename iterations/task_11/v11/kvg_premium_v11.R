# Task 11 v11 — Mean adult standard health-insurance premium by canton, 2026.
#
# v11 vs v10 vs v7:
#   * Zug callout placement, take three. v7 (+90 km E, +50 km N) read
#     as crowding the map; v10 (+140 km E, +90 km N) read as too far.
#     v11 lands at (+115 km E, +68 km N) — roughly the midpoint —
#     so the label clears the country with a comfortable gap but
#     still feels anchored to Switzerland rather than floating off
...
out_pdf <- "iterations/task_11/v11/kvg_premium_v11.pdf"
